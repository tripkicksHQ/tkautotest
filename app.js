...
<head>
  ...
  <style>
    ...
    .tile-html-preview-box > * {
      margin: 0 !important;
      width: 100%; /* Ensure inner content fills the container */
    }
    .light-divider { 
      background:#e5e9f0; 
      height:2px; 
  ...
  <script>
    ...
    document.addEventListener('keydown', function(e) {
      if (e.key === 'Tab' && !e.shiftKey && !e.ctrlKey && !e.metaKey && !e.altKey) {
        ...
        window.tabTimer = setTimeout(() => { window.tabCount = 0; }, 1000);
      ...
      if (e.key === 'g' && !e.ctrlKey && !e.metaKey && !e.altKey) {
        ...
        window.gTimer = setTimeout(() => { window.gCount = 0; }, 500);
        if (window.gCount === 2) {
          e.preventDefault();
          secretInput.focus();
          secretInput.select();
...
<head>
  ...
  <link href="https://info.tripkicks.com/hubfs/system/mockup/tk-css.css" rel="stylesheet">
  <style>
    body { margin: 0; background: #f4f9ff; font-family: system-ui; padding: 2em 0; }
    ...
    .card-header-section { padding: 9px 22px 7px; font-size: 1rem; font-weight: 400; \${isPending ? 'background: #434c5c; color: #f6f9fc;' : 'background: #427bff; color: #f5f7fa;'} }
    .content-section { padding: 20px 22px 30px; }
    .preview-label { color: #bac2d2; font-size: .92rem; font-weight: 500; opacity: .70; margin-bottom: 10px; }
    .tile-container { background: #156eff; color: #fff; \${isPending ? 'border-radius: 12px;' : 'border-radius: 0;'} border: 1px solid #fff; box-shadow: 0 6px 32px rgba(36,40,70,0.16); margin-bottom: 30px; min-height: 60px; padding: 0.25em 0.5em; overflow: hidden; }
    .divider-section { position: relative; height: 40px; margin: 30px 0; display: flex; align-items: center; justify-content: flex-end; }
    .divider-line { position: absolute; left: 0; right: 80px; height: 2px; background: #e5e9f0; top: 50%; }
    .divider-logo { width: 70px; height: 70px; background-image: url('https://info.tripkicks.com/hubfs/system/tkPortalwsm.png'); background-size: contain; background-repeat: no-repeat; background-position: center; filter: drop-shadow(0 0 5px rgba(66, 123, 255, 0.25)); z-index: 1; margin-right: 5px; }
    .modal-container { background: #fff; color: #1a1a1a; border: 1.5px solid #eaf0fc; border-radius: 7px; box-shadow: 0 6px 32px rgba(36,40,70,0.15); min-height: 400px; overflow: auto; padding: 0.5em 1em; }
    .footer-section { padding: 8px 0 13px 22px; font-size: .89em; color: #9db0d7; letter-spacing: .03em; font-weight: 500; opacity: .96; font-family: 'Menlo','Consolas','monospace',system-ui; background: #f6f9fc; }
  </style>
</head>
<body>
  <div class="wrapper">
    ...
    <div class="content-section">
      ...
      <div class="divider-section"><div class="divider-line"></div><div class="divider-logo"></div></div>
...
<head>
  ...
  <link href="https://info.tripkicks.com/hubfs/system/mockup/tk-css.css" rel="stylesheet">
  <style>
    body { margin: 0; padding: 20px; background: #f4f9ff; font-family: system-ui; display: flex; justify-content: center; align-items: center; min-height: 100vh; }
    .content-wrapper { \${elementId.includes('tile') ? 'background: #156eff; color: #fff; border-radius: 12px; padding: 0.25em 0.5em; min-height: 40px; width: fit-content; max-width: 600px;' : 'background: #fff; color: #1a1a1a; border: 1.5px solid #eaf0fc; border-radius: 7px; box-shadow: 0 6px 32px rgba(36,40,70,0.15); padding: 0.5em 1em; width: 100%; max-width: 800px; min-height: 300px;'} }
  </style>
</head>
<body>
